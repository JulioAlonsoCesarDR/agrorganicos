...
class Lib_login
{
    ...
    public function facebook()
    {
        ...
        $helper = new FacebookRedirectLoginHelper('http://local.zoraba.mx:8888/crudRegistro/index.php/registro/addFacebook');
        ...
        if (isset($session)) {
            ...
            $request = new FacebookRequest($session, 'GET', '/me? fields=id,name,first_name,last_name,gender');
